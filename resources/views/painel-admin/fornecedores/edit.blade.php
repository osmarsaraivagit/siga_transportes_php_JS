...
@section('content')
<h5 class="mb-4">EDIÇÃO DE FORNECEDORES</h5>
<form method="POST" action="{{route('fornecedores.editar', $item)}}">
    @csrf
    @method('put')
    <div class="row">
        <div class="col-md-4">
    ...
    <div class="col-md-4">
            <div class="form-group">
                ...
                <input value="{{$item->responsavel}}" type="text" class="form-control" id="" name="responsavel">
            </div>
        </div>
